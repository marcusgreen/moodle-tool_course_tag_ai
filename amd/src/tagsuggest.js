 ...
 *
 * @module     tool_course_tags_ai/tagsuggest
 * @copyright  2025
...
export const init = (courseid, targetUrl) => {
    ...
    button.textContent = (window.M && window.M.str && window.M.str.tool_course_tags_ai
        && window.M.str.tool_course_tags_ai.aisuggestions) ?
        window.M.str.tool_course_tags_ai.aisuggestions : 'AI Suggestions';
